...
for period in range(NT-nblocks+1,0,-nblocks):
    ...
    if 1 <= period <= NT-nblocks:
            ...
            if df_term['UPTIME'][i] > 1:
                ...
                for l in range(df_term['UPTIME'][i]-1,0,-1):
                    if period + nblocks - c1 - 1 <= 0:
                        break
                    if c1 < nblocks:
                        f2 += mu['tv'][ite][i][l-1,period+nblocks]*(m_f[period]._tv[i,nblocks - c1 - 1] - svars['tv'][ite][i,period + nblocks - c1 - 1])
                    else:
                        f2 += mu['tv'][ite][i][l-1,period+nblocks]*(m_f[period]._aux_tv[i,period][df_term['UPTIME'][i]-1-c2] - svars['tv'][ite][i,period + nblocks - c1 - 1])
                        c2+=1
                    c1 += 1
            ...
            if df_term['DOWNTIME'][i] > 1:
                ...
                for l in range(df_term['DOWNTIME'][i]-1,0,-1):
                    if period+nblocks-c1-1 <= 0:
                        break
                    if c1 < nblocks:
                        f3 += mu['tw'][ite][i][l-1,period+nblocks]*(m_f[period]._tw[i,nblocks-c1-1] - svars['tw'][ite][i,period+nblocks-c1-1])
                    else:
                        f3 += mu['tw'][ite][i][l-1,period+nblocks]*(m_f[period]._aux_tw[i,period][df_term['DOWNTIME'][i]-1-c2] - svars['tw'][ite][i,period+nblocks-c1-1])
                        c2+=1
                    c1 += 1
        ...
        for i in range(NH):
            f5 += mu['vol'][ite][period+nblocks][i]*(m_f[period]._vol[i,nblocks-1] - svars['vol'][ite][i,period+nblocks-1])
            ...
            if df_hidr['TRAVELTIME'][i] > 0:
                ...
                for l in range(df_hidr['TRAVELTIME'][i],0,-1):
                    if period+nblocks-c1-1 <= 0:
                        break
                    if c1 < nblocks:
                        f6 += mu['turb'][ite][i][l-1,period+nblocks]*(m_f[period]._turb[i,nblocks-c1-1] - svars['turb'][ite][i,period+nblocks-c1-1])
                        f6 += mu['vert'][ite][i][l-1,period+nblocks]*(m_f[period]._vert[i,nblocks-c1-1] - svars['vert'][ite][i,period+nblocks-c1-1])
                    else:
                        f6 += mu['turb'][ite][i][l-1,period+nblocks]*(m_f[period]._aux_turb[i,period][df_hidr['TRAVELTIME'][i]-1-c2] - svars['turb'][ite][i,period+nblocks-c1-1])
                        f6 += mu['vert'][ite][i][l-1,period+nblocks]*(m_f[period]._aux_vert[i,period][df_hidr['TRAVELTIME'][i]-1-c2] - svars['vert'][ite][i,period+nblocks-c1-1])
                        c2 += 1
                    c1 += 1
            ...
            if df_term['UPTIME'][i] > 1:
                ...
                for l in range(df_term['UPTIME'][i]-1,0,-1):
                    if period + nblocks - c1 - 1 <= 0:
                        break
                    if c1 < nblocks:
                        f2 += mu['tv'][ite][i][l-1,period+nblocks]*(m_b[period]._tv[i,nblocks - c1 - 1] - svars['tv'][ite][i,period + nblocks - c1 - 1])
                    else:
                        f2 += mu['tv'][ite][i][l-1,period+nblocks]*(m_b[period]._aux_tv[i,period][df_term['UPTIME'][i]-1-c2] - svars['tv'][ite][i,period + nblocks - c1 - 1])
                        c2+=1
                    c1 += 1
            if df_term['DOWNTIME'][i] > 1:
                c1,c2 = 0,1
                for l in range(df_term['DOWNTIME'][i]-1,0,-1):
                    if period+nblocks-c1-1 <= 0:
                        break
                    if c1 < nblocks:
                        f3 += mu['tw'][ite][i][l-1,period+nblocks]*(m_b[period]._tw[i,nblocks-c1-1] - svars['tw'][ite][i,period+nblocks-c1-1])
                    else:
                        f3 += mu['tw'][ite][i][l-1,period+nblocks]*(m_b[period]._aux_tw[i,period][df_term['DOWNTIME'][i]-1-c2] - svars['tw'][ite][i,period+nblocks-c1-1])
                        c2+=1
                    c1 += 1
            f4 += mu['gt'][ite][period+nblocks][i]*(m_b[period]._gt[i,nblocks-1] - svars['gt'][ite][i,period+nblocks-1])

        for i in range(NH):
            f5 += mu['vol'][ite][period+nblocks][i]*(m_b[period]._vol[i,nblocks-1] - svars['vol'][ite][i,period+nblocks-1])
            ...
            if df_hidr['TRAVELTIME'][i] > 0:
                ...
                for l in range(df_hidr['TRAVELTIME'][i],0,-1):
                    if period+nblocks-c1-1 <= 0:
                        break
                    if c1 < nblocks:
                        f6 += mu['turb'][ite][i][l-1,period+nblocks]*(m_b[period]._turb[i,nblocks-c1-1] - svars['turb'][ite][i,period+nblocks-c1-1])
                        f6 += mu['vert'][ite][i][l-1,period+nblocks]*(m_b[period]._vert[i,nblocks-c1-1] - svars['vert'][ite][i,period+nblocks-c1-1])
                    else:
                        f6 += mu['turb'][ite][i][l-1,period+nblocks]*(m_b[period]._aux_turb[i,period][df_hidr['TRAVELTIME'][i]-1-c2] - svars['turb'][ite][i,period+nblocks-c1-1])
                        f6 += mu['vert'][ite][i][l-1,period+nblocks]*(m_b[period]._aux_vert[i,period][df_hidr['TRAVELTIME'][i]-1-c2] - svars['vert'][ite][i,period+nblocks-c1-1])
                        c2 += 1
                    c1 += 1
